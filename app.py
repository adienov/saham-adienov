...
# --- 1. SETTING HALAMAN ---
st.set_page_config(page_title="Noris Trading System V30", layout="wide", initial_sidebar_state="expanded")
...
# --- 2. HEADER ---
st.title("📱 Noris Trading System V30")
st.caption("Final Clean Edition: Pure Technical Speed Scanner")
